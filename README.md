...
<p align="center">
  ...
  <a href="https://x.com/codewithtirth">Twitter</a> 
</p>

## 💫 About Me  
🚀 Backend-focused developer passionate about building **secure, scalable, and maintainable APIs**.  
💡 Experienced in **Node.js**, **Express**, authentication systems, and **SQL database design**.  
📚 Projects built: **Bookstore API** and **Job Portal API** (Node.js, Express, JWT Auth, MySQL/PostgreSQL).  
⚡ Currently learning: **Docker**, **AWS**, **PostgreSQL**, and **Go (Golang)** to strengthen cloud and backend expertise.  
🤝 Open to collaborate on **backend projects**, **REST API development**, and **database-driven applications**.  
❓ Fun fact: I prefer solving real-world backend challenges over just following tutorials.  
...
# 📊 GitHub Stats
![](https://github-readme-stats.vercel.app/api?username=TirthWillLearn&theme=default&hide_border=false&include_all_commits=true&count_private=true)  
![](https://github-readme-streak-stats.herokuapp.com/?user=TirthWillLearn&theme=default&hide_border=false)  
